...
export default defineConfig({
  ...
  server: {
    ...
    // Only warm the SPA entry + chat shell. Warming every builtin-tool and
    // package defeats Vite's on-demand compile and inflates dev memory.
    warmup: {
      clientFiles: [
        './src/spa/entry.web.tsx',
        './src/spa/entry.mobile.tsx',
        './src/spa/entry.auth.tsx',
        './src/spa/initialize/**/*.{ts,tsx}',
        './src/spa/router/**/*.{ts,tsx}',
        './src/routes/(main)/_layout/**/*.{ts,tsx}',
        './src/features/Chat*/**/*.{ts,tsx}',
        './src/store/chat/**/*.{ts,tsx}',
        './packages/const/src/buildProfile.ts',
