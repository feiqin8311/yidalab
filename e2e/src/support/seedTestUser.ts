...
export const TEST_USER = {
  ...
  firstName: isParallelWorker ? `E2E Test User ${workerSuffix}` : 'E2E Test User',
...
export async function seedTestUser(): Promise<void> {
  ...
  try {
    ...
    await client.query(
      `INSERT INTO users (id, email, normalized_email, username, first_name, email_verified, onboarding, created_at, updated_at, last_active_at)
