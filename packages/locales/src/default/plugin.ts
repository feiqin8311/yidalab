export default {
  ...
  'builtins.lobe-creds.apiName.connectComposioService': 'Connect Composio service',
  'builtins.lobe-creds.apiName.initiateOAuthConnect': 'Connect OAuth',
  'builtins.lobe-creds.apiName.injectCredsToSandbox': 'Inject credentials',
  'builtins.lobe-creds.apiName.requestWithCred': 'Request with credential',
  'builtins.lobe-creds.apiName.saveCreds': 'Save credential',
  'builtins.lobe-creds.title': 'Credentials',
  ...
  'builtins.lobe-dingpan.portal.noDocument':
    'No HTML artifact on this message — open the DingTalk Drive link instead.',
  ...
  'builtins.lobe-web-onboarding.render.username': 'Username',
  ...
  'audit.expand': 'Expand full result',
  'audit.skillBodyHidden':
    'Skill body is hidden by policy (loaded for the model; not shown in the UI).',
  ...
  'protocolInstall.official.badge': 'YidaLab Official Skill',
  'protocolInstall.official.description': 'Official YidaLab Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, YidaLab will start the command shown below to test the connection. Continue only if you trust this source.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. YidaLab does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
