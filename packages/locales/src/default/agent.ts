export default {
  ...
  'channel.dingtalk.clientIdHint':
    'The Client ID (AppKey) of your DingTalk enterprise internal application.',
  'channel.dingtalk.clientSecret': 'Client Secret',
  'channel.dingtalk.clientSecretHint':
    'The Client Secret (AppSecret) of your DingTalk enterprise internal application. It will be encrypted and stored securely.',
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to YidaLab. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with YidaLab on Slack, Discord, Telegram.',
  ...
  'channel.connectionError.connection_closed':
    'The platform connection was interrupted. YidaLab will try to reconnect automatically.',
  ...
  'channel.connectionError.upstream_unavailable':
    'The platform service is temporarily unavailable. YidaLab will try again later.',
  ...
  'channel.imessage.description':
    'Connect this agent to iMessage through the local YidaLab Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in YidaLab Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and YidaLab Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, YidaLab Desktop receives local BlueBubbles webhooks and forwards them to YidaLab.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to YidaLab. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to YidaLab. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to YidaLab, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The YidaLab Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between YidaLab Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
