export default {
  ...
  'marketSkillModal.install': 'Install to Skills',
  'marketSkillModal.installed': 'Installed',
  'marketSkillModal.publish': 'Publish Skill',
  'marketSkillModal.publishSuccess': 'Skill published to the company market',
  'marketSkillModal.unpublish': 'Unpublish Skill',
  'marketSkillModal.unpublishConfirm': 'This removes the skill from the company market.',
  'marketSkillModal.update': 'Update ZIP',
  'marketSkillModal.upload.desc': 'Upload a standard ZIP package to the company skill market.',
  'marketSkillModal.upload.title': 'Publish Skill',
  'marketMcp.publish': 'Publish MCP',
  ...
  'creds.createCompany': 'Company credential',
  'creds.createCompanyHint': 'Only company admins and owners can create company credentials',
  'creds.createModal.fillForm': 'Fill Details',
  'creds.createModal.selectType': 'Select Type',
  'creds.createModal.title': 'Create Credential',
  'creds.createModal.titleCompany': 'Create Company Credential',
  'creds.createPersonal': 'Personal credential',
  'creds.edit.title': 'Edit Credential',
  'creds.empty': 'No credentials configured yet',
  'creds.companySection.desc':
    'Shared across the company. Everyone can use them; only admins and owners can view or edit secrets.',
  'creds.companySection.empty': 'No company credentials yet',
  'creds.companySection.title': 'Company Credentials',
  ...
  'creds.personalSection.desc':
    'Only you can view, edit, and use these credentials. DingTalk (dingtalk-dingpan) holds your identity and personal 钉盘 folder; the enterprise APP_KEY/SECRET is a company credential.',
  'creds.personalSection.title': 'Personal Credentials',
  'creds.dingpan.defaultName': 'DingTalk',
  'creds.dingpan.defaultDesc':
    'Personal 钉盘 identity and default folder. APP_KEY/SECRET are company-shared; fill UNION_ID or USER_ID plus your folder link.',
  'creds.dingpan.companyName': 'DingTalk App',
  'creds.dingpan.companyDesc':
    'Shared enterprise DingTalk app (钉盘 OpenAPI). One APP_KEY/SECRET for the whole company. Env: DINGTALK_APP_KEY / DINGTALK_APP_SECRET.',
  ...
  'devices.connectWizard.cli.installDesc':
    'Install the YidaLab CLI globally with your preferred package manager to enable device connectivity and management.',
  ...
  'devices.connectWizard.desktop.downloadLink': 'Download YidaLab Desktop',
  'devices.connectWizard.desktop.step1': 'Download the desktop app',
  'devices.connectWizard.desktop.step1Desc':
    'Visit the YidaLab downloads page and get the app for your operating system.',
  ...
  'devices.connectWizard.subtitle': 'Choose how to connect your computer to YidaLab.',
  'devices.connectWizard.title': 'Connect Device',
  'devices.empty.desc':
    'Once connected, YidaLab agents can read/write files, run commands, and call system tools directly on your computer.',
  ...
  'downloads.messenger.desc':
    'Connect YidaLab to the messaging platforms you already use, with quick setup or your own bot configuration.',
  'downloads.messenger.quickSetup': 'Quick setup',
  'downloads.messenger.quickSetupTooltip':
    'You can chat with the official YidaLab account on this platform or manually set up your own.',
  'downloads.messenger.title': 'Messenger integration',
  'downloads.mobile.cta': 'Get Mobile App',
  'downloads.mobile.desc':
    'Start conversations from your phone and keep YidaLab available when you are away from the desk.',
  'downloads.mobile.title': 'Mobile App',
  'downloads.title': 'Discover more ways to use YidaLab',
  ...
  'memory.enabled.desc':
    'Allow YidaLab to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'notification.push.desc':
    'Send push notifications to your mobile devices (YidaLab mobile app required)',
  ...
  'settingAppearance.appTray.desc':
    'Show the YidaLab icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingOpening.openingQuestions.desc':
    'Examples for this agent only (on top of company shared examples). Clicking fills the input (does not send). Use 【ASIN】/【站点】placeholders. First line is the card title.',
  'settingOpening.openingQuestions.empty':
    'Add personal examples for this agent. Company shared examples still show if configured.',
  'settingOpening.openingQuestions.placeholder':
    'e.g. Diagnose traffic for 【站点】【ASIN】 in the last 【时间范围】 and output an HTML report',
  'settingOpening.openingQuestions.repeat': 'This example already exists',
  'settingOpening.openingQuestions.title': 'My recommended examples',
  ...
  'settingSelfIteration.enabled.managedDesc':
    'Always on for Yida AI while Self-Iteration is available.',
  ...
  'settingSystemTools.tools.lobehub.desc': 'YidaLab CLI - manage and connect to YidaLab services',
  ...
  'skillStore.mcpEmptySearch': 'No matching MCP servers',
  'skillStore.mcpEmptyTitle': 'No internal MCP servers',
  ...
  'skillStore.tabs.home': 'Home',
  'skillStore.tabs.lobehub': 'YidaLab',
  'skillStore.tabs.mcp': 'MCP',
  'skillStore.tabs.skills': 'Skills',
  'skillStore.home.title': 'Company capability map',
  'skillStore.home.desc':
    'Overview of market assistants, skills, and company MCPs. Browse installable items in the other tabs.',
  'skillStore.home.assistants': 'Assistants',
  'skillStore.home.assistants.empty': 'No market assistants yet.',
  'skillStore.home.skills': 'Market skills',
  'skillStore.home.mcp': 'Company MCP',
  'skillStore.home.col.name': 'Skill',
  'skillStore.home.col.assistant': 'Assistant',
  'skillStore.home.col.mcp': 'MCP',
  'skillStore.home.col.purpose': 'Purpose',
  'skillStore.home.col.related': 'Related',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tab.memory': 'Memory',
  'tab.recommendedExamples': 'Recommended examples',
  ...
  'tab.usage': 'Quota Allocation',
  'usageQuota.desc':
    'View credit usage details and company limits. Default is 500,000 credits per member every 30 days; admins can raise, unlimited, or lock models.',
  'usageQuota.myQuota': 'My credits',
  'usageQuota.memberQuotas': 'Member credit quotas',
  'usageQuota.monthSpend': 'Used this cycle',
  'usageQuota.monthlyLimit': 'Cycle limit',
  'usageQuota.monthlyCredits': 'Credits / 30 days',
  'usageQuota.remaining': 'Remaining',
  'usageQuota.unlimited': 'Unlimited',
  'usageQuota.defaultBudget': 'Default (500,000 credits / 30 days)',
  'usageQuota.allowedModels': 'Allowed models',
  'usageQuota.allModels': 'All models',
  'usageQuota.noModels': 'No models allowed',
  'usageQuota.modelCount': '{{count}} models',
  'usageQuota.member': 'Member',
  'usageQuota.edit': 'Edit',
  'usageQuota.editTitle': 'Quota · {{name}}',
  'usageQuota.customLimit': 'Custom credits',
  'usageQuota.customModels': 'Selected models only',
  'usageQuota.selectModels': 'Select models',
  'usageQuota.save': 'Save',
  'usageQuota.saved': 'Quota updated',
  'usageQuota.saveFailed': 'Failed to update quota',
  'usageQuota.reset': 'Reset to default (500,000 credits / 30 days)',
  'usageQuota.resetToDefault': 'Reset to default',
  'usageQuota.loading': 'Loading…',
  'usageQuota.noCompany':
    'You are not in a company yet. Join or create a company to use member credit quotas. Usage details still appear above.',
  ...
  'workspaceSetting.entryPoint': 'Settings',
  'workspaceSetting.tab.profile': 'Profile',
  ...
  'workspaceSetting.tab.general': 'Company',
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the YidaLab marketplace. Use this when you need extended capabilities or want to install a specific skill.',
  ...
  'tools.builtins.lobehub.description':
    'Manage the YidaLab platform via CLI — knowledge bases, memory, agents, files, search, generation, and more.',
  'tools.builtins.lobehub.title': 'YidaLab',
