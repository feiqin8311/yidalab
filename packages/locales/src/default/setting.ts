export default {
  ...
  'creds.personalSection.desc':
    'Only you can view, edit, and use these credentials. DingTalk Drive (钉盘) uses your personal folder path — fill dingtalk-dingpan for each account.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-dingpan.readme':
    'Default channel for user-facing files (xlsx/csv/pdf/md/zip). Uses dingtalk-dingpan credential for the default folder; per-upload folder override supported. Prefer Artifacts for interactive HTML in chat. Returns a shareable preview link.',
