export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using YidaLab Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve YidaLab. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve YidaLab',
  ...
  'screen5.actions.signInCloud': 'Sign in to YidaLab Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your YidaLab Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'YidaLab Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own YidaLab server instance',
