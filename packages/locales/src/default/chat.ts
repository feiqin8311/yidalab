export default {
  ...
  'heteroAgent.executionTarget.infoTooltip':
    'Pick a device and the agent uses it as its runtime environment — reading and writing files and operating the computer. Cloud sandbox is provided by YidaLab Marketplace.',
  ...
  'claudeCodeInstallGuide.reason': 'YidaLab could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'YidaLab could not start Codex: {{message}}',
  ...
  'resources.visibility.private': 'Mine',
  'resources.visibility.shared': 'Shared',
  'resources.visibility.workspace': 'Company',
  'resources.visibility.adminAll': 'All',
  'resources.mode.privateHint': 'Resources you created — private by default',
  'resources.mode.sharedHint': 'Private resources others shared with you or your department',
  'resources.mode.workspaceHint': 'Visible to everyone in this company workspace',
  'resources.mode.adminAllHint': 'Admin view of every resource in the workspace',
  'resources.share.menu': 'Manage sharing…',
  'resources.share.title': 'Share resource',
  'resources.share.modePrivate': 'Only me',
  'resources.share.modeWorkspace': 'Whole company',
  'resources.share.modeSpecific': 'Specific people & departments',
  'resources.share.people': 'People',
  'resources.share.departments': 'Departments',
  'resources.share.save': 'Save',
  'resources.share.success': 'Sharing updated',
  'resources.share.error': 'Failed to update sharing',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through YidaLab's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'YidaLab optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to YidaLab',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not YidaLab's, and YidaLab takes no responsibility for it.",
  ...
  'taskSchedule.eventTab': 'Event',
  'taskSchedule.scheduleKind.at': 'Once',
  'taskSchedule.scheduleKind.every': 'Every',
  'taskSchedule.scheduleKind.cron': 'Cron',
  'taskSchedule.eventSource': 'Event type',
  'taskSchedule.event.agent_run_completed': 'Agent run completed',
  'taskSchedule.event.agent_run_failed': 'Agent run failed',
  'taskSchedule.event.tool_run_completed': 'Tool run completed',
  'taskSchedule.event.tool_run_failed': 'Tool run failed',
  'taskSchedule.event.bot_message_received': 'Bot message received',
  ...
  'taskDetail.automationHistory.title': 'Automation history',
  'taskDetail.automationHistory.all': 'All',
  'taskDetail.automationHistory.loading': 'Loading…',
  'taskDetail.automationHistory.empty': 'No automation runs yet',
  'taskDetail.automationHistory.retry': 'Retry',
  'taskDetail.automationHistory.cancel': 'Cancel',
  'taskDetail.automationHistory.loadMore': 'Load more',
  ...
  'taskList.unassignedHint': 'Yida AI will run this task when no assignee is set',
  'taskList.assigneeSearch.empty': 'No matching assistant',
  'taskList.assigneeSearch.me': 'me',
  'taskList.assigneeSearch.memberAssistants': 'Member assistants',
  'taskList.assigneeSearch.placeholder': 'Search assistant...',
  'taskList.assigneeSearch.workspaceAgents': 'Workspace agents',
  ...
  'tool.intervention.onboarding.userProfile.username': 'Username',
