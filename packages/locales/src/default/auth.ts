export default {
  ...
  'betterAuth.errors.signupEmailRequired': 'Please enter your email address',
  'betterAuth.errors.usernameExists': 'This username is already registered. Please choose another',
  'betterAuth.errors.usernameInvalid':
    'Username can only contain letters, numbers, spaces, dots, dashes, underscores, and Chinese characters',
  ...
  'company.create.action': 'Create company',
  'company.create.description':
    'Create a company when you are ready to collaborate. Your personal space stays private.',
  'company.create.title': 'Create your company',
  'company.creator': 'Creator',
  'company.delete': 'Delete',
  'company.delete.action': 'Delete company',
  'company.delete.description': 'This permanently deletes the company and all company content.',
  'company.delete.title': 'Delete this company?',
  'company.department': 'Department',
  'company.departmentAdd': 'Add department',
  'company.departmentPlaceholder': 'e.g. Product',
  'company.invite.accept': 'Accept invitation',
  'company.invite.action': 'Send invitation',
  'company.invite.description': 'Join {{company}} with your invited company profile.',
  'company.invite.emailPlaceholder': 'member@example.com',
  'company.invite.failed':
    'The invitation was saved but the email could not be sent. Retry from this list.',
  'company.invite.resend': 'Resend',
  'company.invite.revoke': 'Revoke',
  'company.invite.signIn': 'Sign in to continue',
  'company.invite.title': 'Company invitation',
  'company.join.action': 'Join company',
  'company.join.description':
    'Already have an invitation? Paste the invitation link or code below.',
  'company.join.placeholder': 'Invitation link or code',
  'company.leave.action': 'Leave company',
  'company.leave.description':
    'You will return to your personal space. Company data will remain separate.',
  'company.leave.failed': 'Could not leave the company. Please try again.',
  'company.leave.title': 'Leave this company?',
  'company.loading': 'Loading company…',
  'company.logout': 'Sign out',
  'company.manage': 'Manage',
  'company.name': 'Company name',
  'company.namePlaceholder': 'e.g. YidaLab',
  'company.none': 'Not in a company yet',
  'company.organization': 'Organization',
  'company.personal': 'Personal space',
  'company.positionPlaceholder': 'e.g. Product Manager',
  'company.retry': 'Retry',
  'company.role': 'Role',
  'company.role.admin': 'Administrator',
  'company.role.member': 'Member',
  'company.role.owner': 'Owner',
  'company.tab.departments': 'Departments',
  ...
  'company.transfer.placeholder': 'Select a member',
  'company.transfer.title': 'Transfer ownership',
  ...
  'profile.usernamePlaceholder':
    'Enter a username (letters, numbers, spaces, dots, dashes, underscores, or Chinese)',
  'profile.usernameRequired': 'Username cannot be empty',
  'profile.usernameRule':
  ...
  'toolUsage.title': 'Tools & Skills',
  'toolUsage.hint':
    'Counts explicit tool invocations (including activateSkill). Silently pinned skills without a tool call are not included.',
  'toolUsage.cards.totalCalls': 'Tool Calls',
  'toolUsage.cards.failedCalls': 'Failed',
  'toolUsage.cards.skillActivations': 'Skill Activations',
  'toolUsage.cards.companyMcpCalls': 'Company MCP',
  'toolUsage.toolsRank.title': 'Tools Rank',
  'toolUsage.toolsRank.left': 'Tool',
  'toolUsage.toolsRank.right': 'Calls',
  'toolUsage.skillsRank.title': 'Skills Rank',
  'toolUsage.skillsRank.left': 'Skill',
  'toolUsage.skillsRank.right': 'Activations',
  'toolUsage.skillsRank.emptyTitle': 'No skill activations',
  'toolUsage.skillsRank.emptyDesc': 'No activateSkill calls in this period',
  'toolUsage.apiTable.title': 'API Detail',
  'toolUsage.userTable.title': 'By User',
  'toolUsage.table.tool': 'Tool',
  'toolUsage.table.api': 'API',
  'toolUsage.table.calls': 'Calls',
  'toolUsage.table.failed': 'Failed',
  'toolUsage.table.user': 'User',
};
