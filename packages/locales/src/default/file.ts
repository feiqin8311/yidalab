export default {
  ...
  'header.actions.obsidian.error': 'Failed to import Obsidian notes',
  'header.actions.obsidian.foundFiles': 'found {{count}} files',
  'header.actions.obsidian.importing': 'Importing Obsidian vault...',
  'header.actions.obsidian.noMarkdownFiles': 'No markdown notes found in the ZIP archive',
  'header.actions.obsidian.partial': 'Successfully imported {{success}} notes, {{failed}} failed',
  'header.actions.obsidian.success': 'Successfully imported {{count}} notes',
  'header.actions.obsidianGuide.cancel': 'Not Now',
  'header.actions.obsidianGuide.desc':
    'Zip your Obsidian vault folder (include .md notes; .obsidian config is skipped). Then select the ZIP to import notes as pages. Wiki links and attachments are imported as plain text for now.',
  'header.actions.obsidianGuide.ok': 'Select Obsidian ZIP',
  'header.actions.obsidianGuide.title': 'Import from Obsidian',
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support file management. Switch to <1>server database deployment mode</1>, or use <3>YidaLab Cloud</3>.',
  ...
  'pageEditor.empty.importObsidian': 'Import from Obsidian',
  ...
  'preview.loadError': 'Failed to load this file.',
  'preview.office.empty': 'This document has no readable content.',
  'preview.office.loadError': 'Failed to preview this document.',
