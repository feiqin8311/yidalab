export default {
  ...
  'navigation.lingxingAds': 'Lingxing Ads Analysis',
  'navigation.amazonOldProductKeyword': 'Old-product Keyword Diagnosis',
  ...
  'remoteServer.configDesc': 'Connect to the remote YidaLab server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'YidaLab Cloud',
