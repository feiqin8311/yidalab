...
export const LOBE_CHAT_CLOUD = 'YidaLab Cloud';

export const BRANDING_NAME = 'YidaLab';
export const BRANDING_LOGO_URL = '/avatars/yida-ai.png';

export const ORG_NAME = 'YidaLab';
