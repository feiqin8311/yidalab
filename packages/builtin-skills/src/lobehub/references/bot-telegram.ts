...
- **Secret Token** (optional): a custom string you define; YidaLab includes it in webhook requests so you can verify they genuinely come from YidaLab — leave blank unless you have a security requirement
