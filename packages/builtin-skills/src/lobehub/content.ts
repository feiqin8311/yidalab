export const systemPrompt = `<yidalab_platform_guides>
...
# YidaLab Platform CLI

You can manage the YidaLab platform via the \`lh\` CLI. Use the \`runCommand\` tool to
run commands.
