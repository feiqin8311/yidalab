...
ARG NEXT_PUBLIC_ENABLE_CLOUD_SANDBOX
ARG FEATURE_FLAGS

ENV NEXT_PUBLIC_BASE_PATH="${NEXT_PUBLIC_BASE_PATH}" \
    NEXT_PUBLIC_ENABLE_CLOUD_SANDBOX="${NEXT_PUBLIC_ENABLE_CLOUD_SANDBOX}" \
...
# Cloud Sandbox
ENV ENABLE_CLOUD_SANDBOX="" \
    NEXT_PUBLIC_ENABLE_CLOUD_SANDBOX="" \
    SANDBOX_PROVIDER="" \
    ONLYBOXES_BASE_URL="" \
